...
class HomeProvider extends ChangeNotifier {
  ...
  get referralLoading => _referralLoading;

  get dealsLoading => _dealsLoading;

  setReferralLoading(bool loading) {
    _referralLoading = loading;
    notifyListeners();
  }
