...
class StateAddress extends State<AddAddress> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    gstNOC = new TextEditingController();
    ...
    if (form.validate()) {
      if (city == null || city!.isEmpty) {
        ...
        Fluttertoast.showToast(
            ...
            backgroundColor: colors.primary);
      }  else if (gstNOC!.text.isEmpty || gstNOC!.text.length< 15 ) {
        // setSnackbar(getTranslated(context, 'areaWarning')!);
        Fluttertoast.showToast(
            msg: "Please Enter GST No. equal to 15 character",
            backgroundColor: colors.primary);
  ...
  //           },
  //           decoration: InputDecoration(
  //               label: Text(getTranslated(context, "GST_NO")!),
  //               fillColor: Theme.of(context).colorScheme.white,
  //               isDense: true,
  //               hintText: getTranslated(context, 'GST_NO'),
  //               border: InputBorder.none),
  //         ),
  //       ),
  //     ),
          ...
          child: TextFormField(
            ...
            validator: (val) {
              if (val == null || val.isEmpty) {
                return getTranslated(context, 'GST_REQUIRED');
              } else if (val.length < 15) {
                print("validation ${val.length}");
                return getTranslated(context, 'GST_REQUIRED');
              } else if (val.length != 15) {
                return getTranslated(context, 'VALID_GST');
              }
              return null;
            },
            onSaved: (String? value) {
  ...
  Future<void> addNewAddress() async {
    ...
    try {
      ...
      print("Get Address Data---------->:AAAAAAAAAA $data");
            ...
            child: Column(
              children: [
                ...
                saveButton(getTranslated(context, 'SAVE_LBL')!, () {
                  print( " gstNOC!.text${ gstNOC!.text}");
                  gSSt =gstNOC!.text;
                  print( " gstNOC!.text${ gSSt}");
                   validateAndSubmit();
                }),
              ],
            )),
